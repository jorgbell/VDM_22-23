...
public class AndroidEngine extends AbstractEngine{
    ...
    public AndroidEngine(AppCompatActivity context){
        super(new AndroidGraphics(context), new AndroidInput(), new AndroidAudio(), new AndroidJSONManager(), new AndroidSensors(context), new AndroidNotificationManager(context), new AbstractEngine.EnginePaths("", "images/", "fonts/", "audio/", "JSON/"));
