...
public class AndroidEngine extends AbstractEngine {
    ...
    public AndroidEngine(AppCompatActivity context){
        super(new AndroidGraphics(context), new AndroidInput(), new AndroidAudio(), new AndroidJSONManager(), new Sensors(), new AbstractEngine.EnginePaths("", "images/", "fonts/", "audio/", "JSON/"));
