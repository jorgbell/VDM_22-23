...
public class MenuScene extends AbstractScene {
    ...
    public boolean init() {
        ...
        _botonJugar = new ChangeSceneButton(_w/7, _h/2, _w / 3, _w / 7, "Juego Rapido", _myEngine, juegoScene, null);
        _botonHistoria = new ChangeSceneButton(_w/7*4, _h/2, _w / 3, _w / 7, "Modo Historia", _myEngine, historiaScene, null);
        return true;
    }
